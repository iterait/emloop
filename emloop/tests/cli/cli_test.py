...
def test_delete_dir_option_train(tmpdir, mocker, simple_yaml):
    ...
    mocker.patch.object(emloop.cli.train_fn, 'create_emloop_training', new=lambda _, __:
                        EmloopTraining('dir', None, None, [], None))
...
def test_delete_dir_option_resume(tmpdir, mocker, simple_yaml):
    ...
    mocker.patch.object(emloop.cli.resume_fn, 'create_emloop_training',
                        new=lambda _, __, ___: EmloopTraining('dir', None, None, [], None))
...
def test_delete_dir_option_eval(tmpdir, mocker, simple_yaml):
    ...
    mocker.patch.object(emloop.cli.eval_fn, 'create_emloop_training', new=lambda _, __, ___:
                        EmloopTraining('dir', None, None, [], None))
