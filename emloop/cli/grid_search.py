...
def _build_grid_search_commands(script: str, params: typing.Iterable[str]) -> typing.Iterable[typing.List[str]]:
    ...
    :param script: String of command prefix, e.g. ``emloop train -v -o log``.
    :param params: Iterable collection of strings in standard **emloop** param form, e.g. ``'numerical_param=[1, 2]'``
