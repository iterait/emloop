...
def get_emloop_arg_parser(add_common_arguments: bool=False) -> ArgumentParser:
    ...
    train_parser.add_argument('--rm', action='store_true', help='Delete directory after training finished')
    ...
    resume_parser.add_argument('--rm', action='store_true', help='Delete directory after resumed training finished')
    ...
    eval_parser.add_argument('--rm', action='store_true', help='Delete directory after evaluation finished')
