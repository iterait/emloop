...
class Sequence(AbstractModel):
    ...
    .. code-block:: python
        ...
        model = cx.models.Sequence(model_paths=['/path/to/step/step1', '/path/to/step/step2'])
        # model.run(...)
    ...
    def __init__(self,
        ...
        :param dataset: optional **cxflow** dataset (will be passed to the underlying models)
