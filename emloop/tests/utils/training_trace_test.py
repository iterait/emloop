...
from emloop.utils import TrainingTrace, TrainingTraceKeys
from emloop.constants import EL_TRACE_FILE
...
def test_save_load(tmpdir):
    ...
    loaded_trace = TrainingTrace.from_file(path.join(tmpdir, EL_TRACE_FILE))
