"""
Module with EveryNEpoch abstract hook which call ``after_n_epoch`` method every n epoch.
"""
...
class EveryNEpoch(AbstractHook, metaclass=ABCMeta):
    ...
    Call ``after_n_epoch`` method every ``n_epochs`` epoch.
    """
    ...
    def __init__(self, n_epochs: int=1, **kwargs):
        ...
        :param n_epochs: how often ``after_n_epoch`` method is called
        """
