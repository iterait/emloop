...
from emloop.models.ensemble import major_vote, Ensemble


_DUMMY_CONFIG = """
model:
  name: test
  class: emloop.tests.models.ensemble_test.DummyModel
...
def create_models(tmpdir):
    ...
    def _create_models():
        ...
        for i in [1, 2, 3]:
            ...
            os.mkdir(model_dir)
            with open(path.join(model_dir, EL_CONFIG_FILE), 'w') as config:
