"""
Test module for EveryNEpoch hook (emloop.hooks.every_n_epoch).
"""

from emloop.hooks.every_n_epoch import EveryNEpoch


class DummyHook(EveryNEpoch):
    """Dummy hook which inherits from :py:class:`emloop.hooks.EveryNEpoch` hook."""
